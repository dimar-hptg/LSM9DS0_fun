...
SRCS=main.c system_stm32f4xx.c stm32f4xx_it.c newlib_stubs.c my_printf.c i2c_driver.c lsm9ds0_driver.c
...
CC=../../../gcc-arm-none-eabi-4_9-2015q1/bin/arm-none-eabi-gcc
OBJCOPY=../../../gcc-arm-none-eabi-4_9-2015q1/bin/arm-none-eabi-objcopy
OBJDUMP=../../../gcc-arm-none-eabi-4_9-2015q1/bin/arm-none-eabi-objdump
...
burn: proj
	...
	$(OBJDUMP) -d -S $(PROJ_NAME).elf  > $(PROJ_NAME).dump
